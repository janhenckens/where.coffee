	...
	grunt.initConfig({
		...
		options: {
			...
			css: {
				...
				files: ['app/assets/css/style_one.css','app/assets/css/style_two.css'],							// CSS files in order you'd like them concatenated and minified
			...
			js: {
				...
				files: ['app/assets/js/script_one.js','app/assets/js/script_two.js'],							// JavaScript files in order you'd like them concatenated and minified
			...
			// SASS Settings
			sass: {
				base: 'app/assets/scss',							// Base path to you SASS folder
				file: 'app/assets/scss/main.scss',							// SASS file (ideally, one file which contains imports)
